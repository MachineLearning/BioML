function [lambda,theta]=optimiseLambda(Xtrain,ytrain,Xcv,ycv,verbose)
	...
	origpoi=page_output_immediately(1);
	...
	for i=1:values
		...
		theta(i,:)=fitParameters(Xtrain,ytrain,lambda(i),400)';
	...
	page_output_immediately(origpoi);
end
